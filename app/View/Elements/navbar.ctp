						...
						<div class="container-fluid">
							...
							<div class="col-sm-12">
								<div class="form-group registro-form">
									<?= $this->Form->input('username', array('label' => false, 'class' => 'form-control setPopover', 'id' => 'focusedInput', 'placeholder' => __('Usuario'), 'data-toggle' => 'popover', 'data-placement' => 'right', 'data-content' => 'Introduce tu nombre de usuario.', 'data-trigger' => 'active', 'aria-describedby' => 'popover906376')) ?>
								</div>
								<div class="form-group registro-form">
								...
								<div class="form-group registro-form">
									<?= $this->Form->input('pass', array('label' => false, 'type' => 'password', 'class' => 'form-control setPopover', 'id' => 'focusedInput', 'placeholder' => __('Contraseña'), 'data-toggle' => 'popover', 'data-placement' => 'right', 'data-content' => 'Introduce una contraseña.', 'data-trigger' => 'active', 'aria-describedby' => 'popover906376')) ?>
								</div>
								<div class="form-group registro-form">
									<?= $this->Form->input('pass2', array('required' => 'required', 'label' => false, 'type' => 'password', 'class' => 'form-control setPopover', 'id' => 'focusedInput', 'placeholder' => __('Repita su contraseña'), 'data-toggle' => 'popover', 'data-placement' => 'right', 'data-content' => 'Repita su contraseña', 'data-trigger' => 'active', 'aria-describedby' => 'popover906376')) ?>
								</div>
							</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group registro-form">
						<?= $this->Form->input('useremail', array('label' => false, 'class' => 'form-control setPopover', 'id' => 'focusedInput', 'placeholder' => __('Correo'), 'data-toggle' => 'popover', 'data-placement' => 'right', 'data-content' => __('Introduce tu email de usuario.'), 'data-trigger' => 'active', 'aria-describedby' => 'popover906376')) ?>

					</div>
					<div class="form-group registro-form">
						<?= $this->Form->input('userpass', array('label' => false, 'type' => 'password', 'class' => 'form-control setPopover', 'id' => 'focusedInput', 'placeholder' => __('Contraseña'), 'data-toggle' => 'popover', 'data-placement' => 'right', 'data-content' => __('Introduce tu contraseña.'), 'data-trigger' => 'active', 'aria-describedby' => 'popover906376')) ?>
					</div>
